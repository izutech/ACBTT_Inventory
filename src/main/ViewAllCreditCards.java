...
public class ViewAllCreditCards {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewAllCreditCards window = new ViewAllCreditCards();
	...
	private void initialize() {
		...
		JLabel lblCreditCards = new JLabel("Credit Cards");
		lblCreditCards.setForeground(new Color(255, 255, 255));
		lblCreditCards.setFont(new Font("Tahoma", Font.BOLD, 11));
		panel.add(lblCreditCards, "cell 0 0");
		...
		btnAddCreditCard.setFocusPainted(false);
		btnAddCreditCard.setContentAreaFilled(false);
		frmViewAllBankAccounts.getContentPane().add(btnAddCreditCard, "flowx,cell 1 6,alignx right");
