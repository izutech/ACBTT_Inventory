...
public class CustomersPage extends JPanel {
	...
	public CustomersPage() {
		...
		JLabel lblCustomerProfile = new JLabel("Customer Profile");
		lblCustomerProfile.setForeground(new Color(255, 255, 255));
		lblCustomerProfile.setFont(new Font("Tahoma", Font.BOLD, 11));
		panel.add(lblCustomerProfile, "cell 0 0");
